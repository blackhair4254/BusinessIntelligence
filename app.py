...
# Load dataset
product_df = pd.read_csv("/Users/mac/Downloads/UNIVERSITAS/Business Intelligence/dataset umkm/product.csv", delimiter=",", on_bad_lines='skip')

# Ambil subkategori unik
all_products = sorted(set(product_df['subCategory'].unique()))

# Load rules dari pickle
rules = pd.read_pickle("/Users/mac/Python3/BusinessIntelligence/rules.pkl")
